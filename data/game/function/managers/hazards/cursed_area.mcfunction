...
summon minecraft:area_effect_cloud 0 0 0 {Tags:["curse"],ReapplicationDelay:10,Radius:4f,Duration:2400,Particle:{type:"minecraft:dragon_breath"},potion_contents:{custom_effects:[{id:"minecraft:slowness",amplifier:0,duration:40},{id:"minecraft:mining_fatigue",amplifier:0,duration:40},{id:"minecraft:nausea",amplifier:0,duration:40},{id:"minecraft:hunger",amplifier:0,duration:40},{id:"minecraft:weakness",amplifier:0,duration:40},{id:"minecraft:wither",amplifier:0,duration:40}]}}
summon minecraft:area_effect_cloud 0 0 0 {Tags:["curse"],ReapplicationDelay:10,Radius:4f,Duration:2400,Particle:{type:"minecraft:dragon_breath"},potion_contents:{custom_effects:[{id:"minecraft:slowness",amplifier:0,duration:40},{id:"minecraft:mining_fatigue",amplifier:0,duration:40},{id:"minecraft:nausea",amplifier:0,duration:40},{id:"minecraft:hunger",amplifier:0,duration:40},{id:"minecraft:weakness",amplifier:0,duration:40},{id:"minecraft:wither",amplifier:0,duration:40}]}}
