...
summon minecraft:interaction ^.3 ^.375 ^ {Tags:["points","increment"],width:0.55,height:0.55}
summon minecraft:interaction ^-.3 ^.375 ^ {Tags:["points","decrement"],width:0.55,height:0.55}
