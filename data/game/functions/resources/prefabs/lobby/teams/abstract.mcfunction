...
summon minecraft:area_effect_cloud ~ ~1.25 ~ {Duration:-1,WaitTime:-2147483648,CustomNameVisible:1b}
execute positioned ~ ~1.25 ~ run data modify entity @e[type=minecraft:area_effect_cloud,sort=nearest,limit=1] CustomName set from block 0 1 0 Text1
