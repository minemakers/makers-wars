...
execute store result score #cost var run data get entity @e[type=minecraft:armor_stand,sort=nearest,limit=1] ArmorItems[3].components."minecraft:custom_data".market.cost 1
