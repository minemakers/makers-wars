...
execute store result score #cost var run data get entity @e[type=minecraft:armor_stand,sort=nearest,limit=1] equipment.head.components."minecraft:custom_data".market.cost 1
