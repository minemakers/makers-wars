data modify block 0 2 0 item set from storage game:core _.equipment.head
execute if data storage game:core _.equipment.head run item replace entity @s armor.head from block 0 2 0 contents
data modify block 0 2 0 item set from storage game:core _.equipment.chest
execute if data storage game:core _.equipment.chest run item replace entity @s armor.chest from block 0 2 0 contents
data modify block 0 2 0 item set from storage game:core _.equipment.legs
execute if data storage game:core _.equipment.legs run item replace entity @s armor.legs from block 0 2 0 contents
data modify block 0 2 0 item set from storage game:core _.equipment.feet
execute if data storage game:core _.equipment.feet run item replace entity @s armor.feet from block 0 2 0 contents
