...
execute if entity @s[tag=increment] run function game:managers/peace/increment
execute if entity @s[tag=decrement] run function game:managers/peace/decrement
