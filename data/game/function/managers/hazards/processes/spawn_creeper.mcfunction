execute at @r[gamemode=!spectator] run summon minecraft:creeper ~ ~40 ~ {Tags:["hazard"],Fuse:40,ExplosionRadius:2,attributes:[{id:"minecraft:max_health",base:1000}],active_effects:[{id:"minecraft:resistance",amplifier:100,duration:200,show_particles:false}]}
