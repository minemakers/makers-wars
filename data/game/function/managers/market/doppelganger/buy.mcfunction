...
execute if score #error var matches 2 run tellraw @a {"storage":"game:lang","nbt":"errors.market.lives","color":"red","interpret":true}
execute if score #error var matches 1 run tellraw @a {"storage":"game:lang","nbt":"errors.market.cost","color":"red","interpret":true}
