...
execute if score #error var matches 3 run tellraw @a {"storage":"game:lang","nbt":"errors.ready.players","color":"red","interpret":true}
execute if score #error var matches 2 run tellraw @a {"storage":"game:lang","nbt":"errors.ready.teams","color":"red","interpret":true}
execute if score #error var matches 1 run tellraw @a {"storage":"game:lang","nbt":"errors.ready.team","color":"red","interpret":true}
