clear @s
effect clear @s
effect give @s minecraft:weakness 1000000 200 true
effect give @s minecraft:resistance 1000000 200 true
effect give @s minecraft:saturation 1000000 200 true
