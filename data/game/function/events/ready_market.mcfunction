...
execute unless score #max var = #min var run tellraw @s [{"text":"\n","color":"gold"},{"text":"\u25c6 ","bold":true},{"storage":"game:lang","nbt":"dialog.balance.text","color":"yellow"},{"text":" [","extra":[{"storage":"game:lang","nbt":"dialog.balance.actions.1.name"},{"text":"]"}],"hover_event":{"action":"show_text","value":[{"storage":"game:lang","nbt":"dialog.balance.actions.1.hover"}]},"click_event":{"action":"run_command","command":"/trigger confirm set 1"}},{"text":" [","extra":[{"storage":"game:lang","nbt":"dialog.balance.actions.2.name"},{"text":"]"}],"hover_event":{"action":"show_text","value":[{"storage":"game:lang","nbt":"dialog.balance.actions.2.hover"}]},"click_event":{"action":"run_command","command":"/trigger confirm set 2"}}]
