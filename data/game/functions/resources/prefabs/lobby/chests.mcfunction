...
summon minecraft:item_display ~ ~1.6 ~ {Tags:["chests","rotate"],Rotation:[180f,0f],transformation:{scale:[1f,1f,1f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f]}}
